...
export const en = {
  ...
  personal_p: {
    ...
    hero: {
      title: "En Sarah Johnson",
      tagline: "Personal Web Demo",
      cta: {
        text: "Hire me",
        href: "/contact" // или нужная ссылка
      },
      subtitle: "I am a graphic designer passionate about creating visual stories. \n With 5 years of experience and a degree from New York University's School of Design, I bring life into brands and designs, turning concepts into captivating realities.",
    },

    // ⬇️ Перенесите блок about сюда
    about: {
      title: "En About me",
      paragraph1: "Welcome to my creative journey. My work is a testament to my commitment to bringing ideas to life, where each pixel becomes a brushstroke in the canvas of imagination.",
      paragraph2: "I find inspiration in the world around me, whether through the pages of a captivating novel, the intricate details of typography, or the vibrant hues of nature during my outdoor escapades.",
      paragraph3: "If you're curious to dive deeper into my work, you can follow me:",
      items: [
    ...
    content: {
      portfolio: {
        title: "En Elevating visual narratives",
        ...
        items: [
          {
            title: "Brand identity for tech innovators",
            ...
            role: "Led the entire branding process from concept to execution. Created a dynamic logo that symbolized innovation, selected a vibrant color palette, and designed corporate stationery, website graphics, and social media assets.",
          },
          {
            title: "Event poster for art & music festival",
            ...
            role: "Translated the festival's creative theme into a visually striking poster. Used bold typography, vibrant colors, and abstract elements to depict the fusion of art and music. Ensured the design captured the festival's vibrant atmosphere.",
          },
          {
            ...
            role: "Conducted a thorough analysis of the brand's values and customer base to inform the design direction. Created a visually appealing interface with intuitive navigation, highlighting sustainable materials, and integrating a user-friendly shopping experience.",
          },
        ],
        image: ""
      },
    ...
    steps: {
      workExperience: [
        {
          title: "Graphic Designer at ABC Design Studio, New York, NY (2021 - Present)",
        ...
        {
          title: "Junior Graphic Designer at XYZ Creative Agency, Los Angeles, CA (2018 - 2021)",
      ...
      education: [
        {
          title: "Master of Fine Arts in Graphic Design, New York University's School of Design (2018 - 2020)",
          icon: 'tabler:school',
        },
        {
